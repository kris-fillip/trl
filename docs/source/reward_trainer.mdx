...
Check out a complete flexible example at [`examples/scripts/reward_modeling.py`](https://github.com/kris-fillip/trl/tree/main/examples/scripts/reward_modeling.py).
