...
<p align="center">
    <a href="https://github.com/kris-fillip/trl/blob/main/LICENSE">
        <img alt="License" src="https://img.shields.io/github/license/kris-fillip/trl.svg?color=blue">
    </a>
    ...
    <a href="https://github.com/kris-fillip/trl/releases">
        <img alt="GitHub release" src="https://img.shields.io/github/release/kris-fillip/trl.svg">
    </a>
</p>
...
- [Examples](https://github.com/kris-fillip/trl/tree/main/examples): Train GPT2 to generate positive movie reviews with a BERT sentiment classifier, full RLHF using adapters only, train GPT-j to be less toxic, [Stack-Llama example](https://huggingface.co/blog/stackllama), etc.
...
```bash
git clone https://github.com/kris-fillip/trl.git
cd trl/
pip install .
```
...
@misc{vonwerra2022trl,
  ...
  howpublished = {\url{https://github.com/kris-fillip/trl}}
}
```
